          ...
          <div className="container-infini flex flex-1 flex-col justify-between pt-[120px]">
            ...
            >
              ...
              <div className="flex items-center gap-6 font-mono text-xs uppercase tracking-[0.18em] text-faint">
                <Link to="/dashboard" search={{ view: "boundary" }} onClick={onClose} className="transition-colors hover:text-ink-muted">
                  Boundary
                </Link>
                <Link to="/contact" onClick={onClose} className="transition-colors hover:text-ink-muted">
                  Pilot terms
                </Link>
